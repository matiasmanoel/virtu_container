    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.log(error_1);
                throw new Error('Error creating product: ' + error_1.message);
...
var listProducts = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel_1.default.find().exec()];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
                error_2 = _a.sent();
                throw new Error('Error listing products: ' + error_2.message);
            case 3: return [2 /*return*/];
        }
    });
}); };
