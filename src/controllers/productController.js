...
var addProductController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nome, descricao, valor, response, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, productService_1.createProduct)(req.body)];
            case 1:
                response = _b.sent();
...
var listProductsController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var products, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, productService_1.listProducts)()];
            case 1:
                products = _a.sent();
